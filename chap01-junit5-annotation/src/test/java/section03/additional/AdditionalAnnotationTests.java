...
public class AdditionalAnnotationTests {
    ...
    public void testignore() {
         ...
         * junit4에서의 @Ignore와 같은 기능을 제공한다. */
    }

    @Test
    @Timeout(value = 1000, unit = TimeUnit.MILLISECONDS) //ex.코딩테스트 제한시간 기법
    ...
    // 클래스 위 어노테이션 @TestMethodOrder(MethodOrderer.OrderAnnotation.class) 작성
    @Test
    @Order(1)
    void testFirst() {}
